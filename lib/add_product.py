...
class AddProductTopWindow(ThemeEngine):
    ...
    def __init__(self, master):
        ...
        self.add_prod_win.title("Sistema de Gestión de Inventario \ Inventario \ Agregar Producto")
        ...
        # Title Label
        title_label = ttk.Label(title_frame, text="AGREGAR PRODUCTO",
        ...
        # New Product Name
        nprod_name_label = ttk.Label(apw_frame1, text="Nombre del Producto", font="Arial 17 bold")
        ...
        nprod_catname_label = ttk.Label(apw_frame1, text="Categoria", font="Arial 17 bold")
        ...
        nprod_subcatname_label = ttk.Label(apw_frame1, text="Sub-Categoria", font="Arial 17 bold")
        ...
        nprod_price_label = ttk.Label(apw_frame1, text="Precio Unitario", font="Arial 17 bold")
        ...
        nprod_qty_label = ttk.Label(apw_frame1, text="Cantidad", font="Arial 17 bold")
    ...
    def add_to_db(self):
        ...
        def insert_success_msg():
            ...
            tk.messagebox.showinfo("Successful",
                                    f"\"{self.fetch_name}\" Agregado a la base de datos",
                                     parent=self.add_prod_win)
            try:
