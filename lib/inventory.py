...
class InventoryWindow(tk.Frame, ThemeEngine):
    ...
    def __init__(self, master):
        ...
        # Title Label
        title_label = ttk.Label(title_frame, text="INVENTARIO ",
        ...
        # Heading Label
        heading_label = ttk.Label(product_list_frame, text="Lista de Productos",
        ...
        self.product_list_treeview.heading('one', text='Nombre del Producto')
        self.product_list_treeview.column('one', minwidth=255, width=255,
                                             anchor="c", stretch=False)

        self.product_list_treeview.heading('two', text='Categoria')
        self.product_list_treeview.column('two', minwidth=150, width=150,
                                             anchor="c", stretch=False)

        self.product_list_treeview.heading('three', text='Sub-Categoria')
        self.product_list_treeview.column('three', minwidth=150, width=150,
                                             anchor="c", stretch=False)

        self.product_list_treeview.heading('four', text='Cantidad')
        self.product_list_treeview.column('four', minwidth=80, width=80,
                                             anchor="c", stretch=False)

        self.product_list_treeview.heading('five', text='Precio Unitario')
        self.product_list_treeview.column('five', minwidth=82, width=82,
                                             anchor="c", stretch=False)
        
        self.product_list_treeview.heading('six', text='Total')
        ...
        # Product Name Search
        prod_name_label = ttk.Label(product_list_frame, text="Buscar Producto",
                                     font="Arial 16 bold")
        prod_name_label.place(x=50, y=470)
        ...
        add_product_btn = tk.Button(add_product_frame, image=self.add_product_btn_img, bd=0,
                                     bg=self.button_bg, activebackground=self.button_bg,
                                    text="Agregar Producto", font=("Arial", 20, "bold"),
        ...
        selected_prod_name_label = ttk.Label(product_menu_frame,
                                        text="Nombre del Producto", font="Arial 16 bold")
        selected_prod_name_label.place(x=60, y=70)
        ...
        # Product Quantity
        selected_prod_qty_label = ttk.Label(product_menu_frame, text="Cantidad",
                                             font="Arial 16 bold")
        ...
        selected_prod_price_label = ttk.Label(product_menu_frame,
                                     text="Precio($)", font="Arial 16 bold")
...
##============================== OTHER METHODS ===================================================##
    ...
    def select_product(self):
        try:
            ...
            tk.messagebox.showwarning("Warning", "Seleccione un producto de la lista")
