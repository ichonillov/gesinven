...
class LoginWindow(ttk.Frame, ThemeEngine):
    def __init__(self, master):
        ...
        master.title("Sistema de Gestión de Inventario/ Login")
        ...
        # Adding Title
        title = ttk.Label(self.bg_frame, text="INCIO DE SESIÓN",
        ...
        # Username
        username_label = ttk.Label(self.bg_frame, text="Usuario",
                                    font="Arial 20 bold")
        ...
        # Password
        password_label = ttk.Label(self.bg_frame, text="Contraseña",
                                     font="Arial 20 bold")
    ...
    def validating_login(self, *args):
        ...
        if self.username.get() == "" or self.password.get() == "":
            tk.messagebox.showwarning("Warning", "Se requiere usuario y contraseña")
        # Correct combination   '\' below is used to continue statement in the next line
            ...
            tk.messagebox.showinfo("Norma Valencia", f"Bienvenido {self.username.get()}")
            self.master.switch_frame(main_menu.MainMenuWindow, self.bg_frame)
        # Incorrect condition
        else:
            tk.messagebox.showerror("Error", "Nombre de usuario y contraseña incorrectos")
