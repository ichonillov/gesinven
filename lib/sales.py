...
class SalesWindow(tk.Frame, ThemeEngine):
    def __init__(self, master):
        ...
        # Title Label
        title_label = ttk.Label(title_frame, text="VENTAS", font="Arial 60 bold",
                                foreground='#22d3fe')
        ...
        # Heading Label
        heading_label = ttk.Label(customer_details_frame, text="Detalles del Cliente",
                                 font="Arial 15 bold", foreground='#4eacfe')
        heading_label.grid(row=0, column=0, padx=30, pady=10) 
        # Customer Name Label and Entry
        cname_label = ttk.Label(customer_details_frame, text="Nombre del Cliente",
                                 font="Arial 16 bold")
        ...
        cno_label = ttk.Label(customer_details_frame, text="No. Contacto",
                                 font="Arial 16 bold")
        ...
        heading_label = ttk.Label(options_frame, text="Opciones", font=("Arial", 15, "bold"), foreground='#4eacfe')
        heading_label.grid(row=0, column=0, padx=30, pady=10) 
        ...
        # Heading Label
        heading_label = ttk.Label(selection_frame, text="Selección de Producto",
                                 font="Arial 15 bold", foreground='#4eacfe')
        heading_label.grid(row=0, column=0, padx=30, pady=10)
             
        # Category 
        category_label = ttk.Label(selection_frame, text="Categoria",
                                     font="Arial 16 bold")
        ...
        # Sub Category
        sub_category_label = ttk.Label(selection_frame, text="Sub-Categoria",
                                     font="Arial 16 bold")
        ...
        # Product / Item
        product_label = ttk.Label(selection_frame, text="Producto",
                                 font="Arial 16 bold")
        ...
        # Quantity
        qty_label = ttk.Label(selection_frame, text="Cantidad",
                             font="Arial 16 bold")
        ...
        # Price Per Unit
        price_label = ttk.Label(selection_frame, text="Precio Unitario",
                                 font="Arial 16 bold")
        ...
        # Total Price
        tprice_label = ttk.Label(selection_frame, text="Total",
                                 font="Arial 16 bold")
    ...
    def bill_records(self):
        ...
        """
        tk.messagebox.showinfo("Wait", "Por f")
        try:
