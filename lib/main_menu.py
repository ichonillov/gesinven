...
import os
import sys
# Imprimimos la ruta de los modulos de python
...
# Importamos la clase ThemeEngine


class MainMenuWindow(ttk.Frame, ThemeEngine):
    """ Pantalla principal del sistema de gestión de inventario """
    def __init__(self, master):
        ttk.Frame.__init__(self, master)
        # Inicializamos el motor de temas
        ...
        # Imprimimos las coordenadas de la ventana (x_cordinate, y_cordinate)
        ...
        # Agregamos un icono al menu del titulo
        ...
        # Title Label
        title_label = ttk.Label(title_frame, text="MENÚ PRINCIPAL",
        ...
        # Program Title
        program_title_label = ttk.Label(body_frame, text="SISTEMA DE GESTIÓN DE INVENTARIO",
        ...
        sales_button = tk.Button(body_frame, text="Ventas", image=self.sales_btn_img,
        ...
        inventory_button = tk.Button(body_frame , text="Inventario", image=self.inventory_btn_img,
                                 bd=0, bg=self.button_bg, activebackground=self.button_bg,
        ...
        exit_button = tk.Button(body_frame , text="Salir", image=self.exit_btn_img,
                                 bd=0, bg=self.button_bg, activebackground=self.button_bg,
                                command=master.quit)
